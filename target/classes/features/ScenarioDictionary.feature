Feature: Has all the scenario steps from 'Checkout & MCC', Mobile and MAML projects 

@Scenario8
Scenario: Steps for Gherkin Dictionary
...
Given I add "STH" item to cart and click Checkout Now
Given I add another "itemType" item to cart
Given I add another "itemType" item to cart with "same zip code"
Given I add product to New List from shopping cart
...
Given I am on "Enter Payment" Section with a "STH/BOSS/BOPIS/Appliance" product
Given I am on "pageName" page
Given I am on "pageName" page with a "STH/BOSS/BOPIS/Appliance" product
Given I am on "pageName" page with a "STH/BOSS/BOPIS/Appliance" product using a "credit card"
Given I am on Order Confirmation page with a "STH" product with "HDPP" as a "Guest/Registered" User
Given I am on Shipping Address section with a "STH" product as "Guest/Registered" User
Given I apply promotion in cart
Given I browse using category
...
Given I check for zero in stock message in PIP page
...
Given I clear the quantity of an item in cart
...
Given I click "yes/no" for assembly sku
Given I click Add to cart from My list
Given I click Add to cart/List from "pageName" page
...
Given I click CTA button near the zip code look field
...
Given I click on Add Plan option in ATC modal
...
Given I click on menu Item from header in "pageName" page
...
Given I click SigIn In from "location"
...
Given I enter the shipping addrees in Shipping page and click continue button
...
Given I Increase the quantity and click on update link
Given I jump Cart page with a "BOPIS/BOSS/STH/APPLIANCE" product
Given I launch the redirect url for "Workshop" link
...
Given I search using "Keyword/Brand/SKU/Model Number"
Given I see "Add Protection Plan" in Cart page
Given I see "item not in stock for delivery" error message
...
Given I see "schedule delivery" displayed
...
Given I see “ADDED TO CART” message
...
Given I see multiple products added in cart
...
Given I see SignIn error message in overlay
...
Given I see the following error message displayed "smallErrorMessage"
...
Given I select "Price Low to High/Price High to Low" filter in PLP page
...
Given I should not see "Aisle Bay Info" displayed below FILTER RESULTS button
Given I should not see callout option in thank you page for mixed cart
Given I should see "Find It Aisle" section in the PLP page
Given I should see "SBOTD/Banner/Hero Image/RecentlyViewed/Footer/Header" section in "pageName" page
Given I should see "someOption" option
Given I should see Order Summary section
Given I should see that HDPP Qty is updated in cart page
Given I should see the "pageName" page with standard features
Given I should see the Header and Footer flexed and body centered to 320px
Given I should see the In Store checkbox selected in "pageName" page
Given I should see the keyword retained in the search box
Given I should see the Save "$XXXX.XX" displayed as a badge in Home page
...
Given I tap on "FilterResults/SortResults" button in PLP page
Given I tap on "SIGN IN" in Checkout Sign In page
Given I tap on "Store locator/Menu/Search/Cart/Change Store/THD" icon in header
Given I tap on "StoreName/More Details/Set as my Store" in the "Store Finder" page
Given I tap on "Terms and conditions/Ask A question" on Question page
Given I tap on a product using "Image/ProductTitle" in "pageName" page
Given I tap on an Image in "RecentlyViewed/CustomerViewed" section in "pageName" page
Given I tap on More Details button of the localized store in Store finder page
Given I turn the mobile in "Landscape/Portrait" mode
Given I update the qty of an item in cart
Given I validate pick up options
Given I validate price, item total and sub total in MLDP
Given I validate secure checkout page
...
Given I verify "Check Inventory" in any PLP SKU PODs Displayed
Given I verify "HDPP overlay" with standared features
...
Given I verify item level error message "shortMessage" displayed
...
Given I verify the POD of item with Instant Rebate Displayed
Given I verify the SBOTD carousel for the SKU with "MST Data WAS and NOW price"
...
Given the "pageName" page should be positioned to centre of the screen
